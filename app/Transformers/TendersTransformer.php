...
class TendersTransformer extends TransformerAbstract
{
    ...
    public function transform(Tenders $tender)
    {
        ...
        return [
            ...
            'company_status'=> ($tender->company_status) ? $tender->company_status : false,
            'tenderMyCompany'=> ($tender->tenderMyCompany)? $tender->tenderMyCompany : false,
            'userMyCompanySlug'=> ($tender->userMyCompanySlug)? $tender->userMyCompanySlug : false,
