...
class SendUpdateQuoteCompany extends Mailable
{
    ...
    {
        return $this->view('emails.quote.send-update-quote-company')
            ->subject('Se ha creado una nueva adenda para la cotización ' . $this->quoteName)
            ->with([
