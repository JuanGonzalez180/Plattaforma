@include('emails.partials.header')
    ...
    El administrador de la licitación <b>{{$tender_name}}</b> ha decidido cerrar y eliminar la licitación, por lo tanto la compañía <b>{{$company_name}}</b> deja de estar participando en dicha licitación.
    </div>
