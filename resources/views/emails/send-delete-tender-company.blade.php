@include('emails.partials.header')
    ...
    El administrador de la licitación <b>{{$tender_name}}</b> ha decidido cerrar y eliminar la licitación. por el cual la compañía <b>{{$company_name}}</b> deja de esta participando en dicha licitación.
    </div>
