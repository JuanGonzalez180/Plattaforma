@include('emails.partials.header')
    ...
    <div style="padding: 10px 0; font-size: 15px; line-height: 1.3;">
        Se informa que la licitación <b>{{ $tenderName }}</b> ha sido <b>declinada</b>. por lo tanto la compañia <b>{{ $companyName }}</b> y compañias participantes dejan de participar en dicha licitación.
    </div>
