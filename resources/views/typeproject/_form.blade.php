...
<div class="col-md-12 mb-2">
    @if( $typeproject->image )
        <img id="preview-image-before-upload" src="{{ url('storage/' . $typeproject->image->url ) }}" alt="preview image" style="max-height: 250px;">
    @else
...
<div class="col-md-12 mb-2">
    @if( $typeproject->icon )
        <img id="preview-icon-before-upload" src="{{ url('storage/' . $typeproject->icon->url ) }}" alt="preview image" style="max-height: 250px;">
    @else
