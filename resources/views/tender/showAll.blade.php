...
<div class="container">
    <div class="row">
        <div class="col-sm">
            ...
            <select name="company" id="company" class="form-control form-control-sm" onchange="getCompany();">
        ...
        <div class="col-sm">
            ...
            <select name="status" id="status" class="form-control form-control-sm" onchange="getStatus();">
                <option value="all">Todas</option>
        ...
        <div class="col-sm">
            ...
            <select name="order" id="order" class="form-control form-control-sm" onchange="getOrder();">
